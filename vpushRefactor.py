...
parser.add_argument('--bsp',  action='store_const', const=2323, help='Push a poll on a BroadSign Player on port 2323 by default.')
parser.add_argument('--bses', action='store_const', const=2324, help='Push a poll on a BroadSign Edge Server on port 2324 by default.')
parser.add_argument('--port', '-p', action='store_true', help='Specify a different port for the telnet connection.')
parser.add_argument('--ip', '-t', action='store_true', help='Specify one target IP or a list of IPs in a comma separated list.')
